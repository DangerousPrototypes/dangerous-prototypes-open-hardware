...
// MPU wrappers are not used by these processors and so the mpu_wrappers.h
// file has been removed.  The following defines were the only part of that 
// header file that would be included for these processors.
//****************************************************************************/
