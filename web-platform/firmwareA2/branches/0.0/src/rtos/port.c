...
//****************************************************************************/
//****************************************************************************/
// Changed from FreeRTOS distridution to simplify it for dsPIC/PIC24 only use. 
// The compiler macro MPLAB_DSPIC_PORT is not needed now and should not be used
#define MPLAB_DSPIC_PORT
// This is needed in this file so the corrrect portRESTORE_CONTEXT() is built. 
//****************************************************************************/
//****************************************************************************/
...
//****************************************************************************/
//****************************************************************************/
// Change the FreeRTOS TICK Timer from Timer1 to Timer5
// The RTCC can only use Timer1
//****************************************************************************/
///*
