...
<div id="globalWrapper" class="home blog two-sidebars">
 <!--custom-->
 <div id="page">
  <div id="page-inner"> <a id="navigation-top"></a>
...
<div id="p-search" class="portlet">
 ...
 <div id="searchBody" class="pBody">
  <form action="<?php $this->text('wgScript') ?>" id="searchform">
   ...
   <?php } else { ?>
   <div><a href="<?php $this->text('searchaction') ?>" rel="search">
 ...
 <div class="pBody">
  <ul>
   ...
   <li id="t-print"><a href="<?php echo htmlspecialchars($this->data['nav_urls']['print']['href'])
				?>" rel="alternate"<?php echo $this->skin->tooltipAndAccesskey('t-print') ?>>
...
<div class='generated-sidebar portlet' id='<?php echo Sanitizer::escapeId( "p-$bar" ) ?>'<?php echo $this->skin->tooltip('p-'.$bar) ?>>
 <h5>
  <?php $out = wfMsg( $bar ); if (wfEmptyMsg($bar, $out)) echo htmlspecialchars($bar); else echo htmlspecialchars($out); ?>
 </h5>
 <div class='pBody'>
