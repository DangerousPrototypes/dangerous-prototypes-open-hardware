...
int parseCommandLine(int argc, char** argv)
{
	...
	if( argc == 1 )	{
		...
		//printf("%s\n", argv[0]);
		printf("parameters:\n");
		printf("-p:PORT  - port of PUMP, needs to be specified\n\n");
...
//		printf("-verbode - be noisy\n");
		...
		printf("To read Flash to HEX file 'pump.hex' from PUMP on COM2:\n");	
		printf("pump-loader -p:COM2 -rH:pump.hex -read\n");	
		printf("To erase and write flash, data in BIN file 'pump.bin', PUMP on COM2:\n");	
		printf("pump-loader -p:COM2 -wB:pump.hex -write -erase\n");	
		printf("To get status, and jump to run mode, PUMP on COM2:\n");	
		printf("pump-loader -p:COM2 -run -status\n");	
